...
def main():
    ...
    """
    This script shows an example of Boto3 RDS integration with Stratoscale.
    The scenario:
    ...
    # creating a RDS client connection to Stratoscale AWS Compatible region
    ...
    if describe_eng_ver_response['ResponseMetadata']['HTTPStatusCode'] == 200:
        eng_list =  == ENGINE_NAME and engine['EngineVersion'] == ENGINE_VERSION]
    ...
    # check modify DB Params g.roup returned successfully
    ...
    db_restored_name = 'test_restored_snapshot_db_%s' % 
